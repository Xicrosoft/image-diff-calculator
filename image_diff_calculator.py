...
class ImageDiffCalculator:
    ...
    def calculate_pixel_diff_ratio(self, img1: np.ndarray, img2: np.ndarray, threshold: int = 30) -> float:
        """
    ...
    def calculate_diff_ratio(self, image1_path: str, image2_path: str, method: str = 'mse') -> dict:
        ...
        if method not in self.supported_methods:
            raise ValueError(f"Unsupported method: {method}. Supported methods: {self.supported_methods}")
    ...
    def save_diff_visualization(self, image1_path: str, image2_path: str, output_path: str = 'diff_visualization.png'):
        """
...
def main():
    ...
    parser.add_argument('--method', '-m', choices=['mse', 'ssim', 'histogram', 'pixel_diff', 'hash', 'all'],
                       default='mse', help='Calculation method (default: mse)')
    parser.add_argument('--visualize', '-v', action='store_true', help='Generate difference visualization')
    parser.add_argument('--output', '-o', default='diff_visualization.png', help='Visualization output path')
    ...
    try:
        if args.method == 'all':
            ...
            print(f"Image difference calculation results:")
            print(f"Method: {result['method'].upper()}")
            print(f"Similarity: {result['similarity_ratio']:.4f}")
            
            # Print detailed information
            for key, value in result.items():
                if key not in ['image1_path', 'image2_path', 'method', 'image_size', 'similarity_ratio']:
